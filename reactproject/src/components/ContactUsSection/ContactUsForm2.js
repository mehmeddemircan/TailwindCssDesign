      ...
      <div class="grid lg:grid-cols-2 grid-cols-1">
        ...
        <div class="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
          ...
          <textarea
            rows={40}
            type="text"
            class="w-full h-48 text-gray-600 placeholder-gray-400 bg-transparent text-lg shadow-sm font-normal leading-7 rounded-3xl border border-gray-200 focus:outline-none pl-4 mb-10"
            placeholder="Message"
          />
