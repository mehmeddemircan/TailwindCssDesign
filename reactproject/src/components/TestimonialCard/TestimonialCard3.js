...
const TestimonialCard3 = () => {
  return (
 <Fragment>
    <h2 class="my-12 text-xl text-center">Testimonial Card Component</h2>
    <div class="my-5 container flex flex-wrap justify-center items-center">
    ...
    <p class="md:text-lg leading-relaxed">It's incredibly easy  to integrate into our applications, and it has saved us countless hours of development time.</p>
    <div class="flex items-center gap-2">
        <img alt="Yifan testimonial for ShipFast" loading="lazy" width="48" height="48" decoding="async" data-nimg="1" class="w-10 h-10 rounded-full object-cover" src="https://images.unsplash.com/photo-1566492031773-4f4e44671857?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwxMnx8bWFufGVufDB8MXx8fDE2OTYxNzE4MzN8MA&ixlib=rb-4.0.3&q=80&w=1080" />
